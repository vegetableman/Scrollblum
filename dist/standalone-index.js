(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.ScrollBlum = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
var _cssStyler = require('css-styler');

var _cssStyler2 = _interopRequireDefault(_cssStyler);
...
var lowerBound = function lowerBound(arr, value) {
  ...
  while (left < right) {
    var m = left + right >> 1;
    if (defaultComparator(value, arr[m]) > 0) left = m + 1;else right = m;
  }
...
var ScrollBlum = function () {
  ...
  _createClass(ScrollBlum, [{
    ...
    value: function getVisibleIndexes(scrollTop) {
      var firstVisibleIndex = Math.max(lowerBound(this.cumulativeHeights, scrollTop), 0),
    ...
    value: function getRow(index) {
      var row = this.rowRenderer(index);
    ...
    value: function refresh() {
      var scrollTop = this.scrollContainer.scrollTop,
          _getVisibleIndexes = this.getVisibleIndexes(scrollTop),
          firstVisibleIndex = _getVisibleIndexes.firstVisibleIndex,
          lastVisibleIndex = _getVisibleIndexes.lastVisibleIndex;


      if (firstVisibleIndex < lastVisibleIndex) {
        // set the height of the gaps
        (0, _cssStyler2.default)(this.topGap, {
          height: (this.cumulativeHeights[firstVisibleIndex - 1] || 0) + 'px'
        });

        (0, _cssStyler2.default)(this.bottomGap, {
        ...
        var items = Array.from(this.contentElement.children);
        ...
        var anchor = this.contentElement.firstChild;
        var _iteratorNormalCompletion2 = true;
        var _didIteratorError2 = false;
        var _iteratorError2 = undefined;

        try {
          for (var _iterator2 = visibleItems[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var _item = _step2.value;

            if (!anchor || _item !== anchor.dataset['key']) {
              this.contentElement.insertBefore(this.getRow(_item), anchor);
            } else {
    ...
    key: 'reBuildCumulativeHeight',
    value: function reBuildCumulativeHeight() {
    ...
    value: function initRender() {
      var rows = [],
          _getVisibleIndexes2 = this.getVisibleIndexes(1),
          firstVisibleIndex = _getVisibleIndexes2.firstVisibleIndex,
          lastVisibleIndex = _getVisibleIndexes2.lastVisibleIndex;
      ...
      return (0, _hyperscript2.default)('div.scroll-container', {
        style: {
          overflow: 'auto',
          transform: 'translateZ(0)'
        },
        onscroll: this.onScroll
      }, (0, _hyperscript2.default)('div.top-gap', {
        style: {
          height: 0 + 'px'
        }
      }), (0, _hyperscript2.default)('div.content', rows), (0, _hyperscript2.default)('div.bottom-gap', {
        style: {
